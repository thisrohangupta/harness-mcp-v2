/**
 * Tests for the documentation toolset's custom extractor and bodyBuilder.
...
describe("documentation bodyBuilder", () => {
  ...
  it("defaults to empty string when no query key is present", () => {
    const body = bodyBuilder({}) as Record<string, unknown>;
